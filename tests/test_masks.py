...
def test_mask_get_account_card(value: str, expected: str) -> None:
...
def test_get_mask_card_number_various_input_data(value: str, expected: str) -> None:
...
def test_get_mask_account_various_input_data(value: str, expected: str) -> None:
    """Тест на срабатывание функции при введении различных некоректных данных"""
    assert get_mask_account(value) == expected
