...
@pytest.fixture
def path():
    path_file = os.path.join(os.path.dirname(os.path.dirname(__file__)), "data", "operations.json")
    return path_file


@pytest.fixture
def path_empty_list():
    path_file = os.path.join(os.path.dirname(os.path.dirname(__file__)), "data", "operations_1.json")
    return path_file


@pytest.fixture
def path_mistake_json():
    path_file = os.path.join(os.path.dirname(os.path.dirname(__file__)), "data", "operations_2.json")
    return path_file
